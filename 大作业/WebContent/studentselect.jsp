...
<td><a href="teacherall1">刷新</a></td>
<td><a href="studentmap.jsp">学生界面</a></td>
<td><a href="markstudentmap.jsp">学生分数界面</a></td>
<td><form action="teacherfindOne2" method="post"> <input type="text" name="tsid"><input type="submit" value="查找"></form></td>
</tr></table>
<table border="1">
<tr>
	<th>序号</th>
...
<c:forEach items="${teacher}" var="s">
	<tr>
		...
		<td><a href="teacherfindOne1?tsid=${s.tsid}">添加</a></td>
	</tr>
</c:forEach>
